...
class SlotScreen extends ConsumerWidget {
  ...
  static const _days = [
    ...
    ('Thu', '30 Jul'), ('Fri', '31 Jul'), ('Sat', '1 Aug'), ('Sun', '2 Aug'),
  ];
  static const _am = ['10:00 – 11:00 am', '11:00 – 12:00 pm'];
  static const _pm = [
        ...
        children: [
          ...
          CareCard(
            child: Row(children: [
              ...
              Expanded(
                child: Text(
                    'Payments run through Razorpay. Card details never touch Rasoi Care servers.',
                    style: context.type.bodySmall),
              ),
            ]),
          ),
