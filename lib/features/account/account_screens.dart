              ...
              child: switch (_tab) {
                ...
                _ => Padding(
                    ...
                    child: EmptyState(
                      ...
                      body:
                          'Cancelled visits appear here with any refund status.',
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Mono(booking.id.split('-').take(2).join('-'),
        ...
        child: ListView(
          ...
          children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const StatusChip('Silver member',
            ...
            Row(children: [
              ...
              Expanded(
                  child: _MiniStat(
                      label: 'Saved with Rasoi Care', value: '₹8,420')),
            ]),
            const SectionHeader('Your Rasoi Care'),
            CareCard(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              child: Column(children: [
                _NavRow(
                    icon: Icons.event_note,
                    label: 'Bookings and history',
                    onTap: () => context.go('/bookings')),
                _NavRow(
                    icon: Icons.shield_outlined,
                    label: 'Plans, warranty, appliances',
            ...
            // Staff-only — hidden entirely for plain customers. The router
            // also blocks direct navigation to these routes (see
            // app/router.dart), so this is a convenience, not the only gate.
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 3),
                        Text(
                            'Job feed, checklist, invoice and payment collection',
                            style: context.type.bodySmall),
                      ],
                    ),
                  ),
            ...
            if (role == UserRole.admin) ...[
              CareCard(
                ...
                child: Row(children: [
                  Blob('◈',
                      glyph: true,
                      bg: context.scheme.primaryContainer,
                      fg: context.scheme.primary),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
            ...
            Center(
                child: Text('Rasoi Care 0.1.0 · build 1',
                    style: context.type.bodySmall)),
          ],
        ),
      ),
        ...
        child: ListView(
          ...
          children: [
            CareCard(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text('Rasoi Care Complete',
                      style:
                          CareType.display(context.scheme.onPrimary, size: 24)),
                  const SizedBox(height: 16),
                  Row(children: [
                  ...
                  ClipRRect(
                    ...
                    child: LinearProgressIndicator(
                      ...
                      minHeight: 7,
                      backgroundColor:
                          context.scheme.onPrimary.withValues(alpha: 0.2),
                      valueColor:
                          AlwaysStoppedAnimation(context.scheme.secondary),
                    ),
                  ),
                ],
              ),
            ...
            _PlanCard(
                ...
                price: '₹3,499',
                blurb:
                    '4 visits · up to 4 appliances · 20% off repairs · priority slots',
                current: true),
            const SizedBox(height: 10),
            _PlanCard(
                name: 'Home Suite',
                price: '₹5,999',
                blurb:
                    'Unlimited visits · every kitchen appliance · 30% off · 4-hr response',
                best: true),
          ],
        ),
      ),
                ...
                Row(children: [
                  ...
                  if (current)
                    const StatusChip('Current',
                        tone: ChipTone.success, height: 22),
                  if (best)
                    const StatusChip('Best value',
                        tone: ChipTone.warning, height: 22),
                ]),
                Text('$price/yr',
                    style: CareType.mono(context.scheme.onSurface,
