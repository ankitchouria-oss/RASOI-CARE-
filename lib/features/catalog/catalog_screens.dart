                ...
                for (final a in Appliance.values)
                  CareCard(
                    ...
                    child: Row(children: [
                      ...
                      if (a.comingSoon)
                        const StatusChip('Coming soon', height: 26)
                      else
                        Column(
...
class _ServiceDetailState extends ConsumerState<ServiceDetailScreen> {
  ...
  Widget build(BuildContext context) {
    if (widget.appliance.comingSoon) {
      return Scaffold(
        appBar: AppBar(
                ...
                children: [
                  Container(
                    ...
                    child: Text(widget.appliance.glyph,
                        style: TextStyle(
                            fontSize: 34, color: context.scheme.primary)),
                  ),
                  const SizedBox(height: 22),
                  Text('${widget.appliance.label} — coming soon',
                      textAlign: TextAlign.center,
                      style: context.type.headlineMedium),
                  const SizedBox(height: 10),
                  Text(
                      "We're still training and certifying technicians for this appliance. It'll be bookable in the app shortly.",
                      textAlign: TextAlign.center,
                  ...
                  FilledButton(
                    onPressed: () => ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                            content: Text("We'll notify you when this opens up"))),
