...
enum Appliance {
  ...
  refrigerator('Refrigerator', '❄', comingSoon: true),
  otg('OTG', '▦'),
  purifier('Water purifier', '◈', comingSoon: true);

  const Appliance(this.label, this.glyph, {this.comingSoon = false});
  final String label;
  final String glyph;
